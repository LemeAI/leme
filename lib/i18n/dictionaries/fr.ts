...
export const fr: Dictionary = {
  ...
  contributions: {
    ...
    forkDisabledHint: "Les forks sont désactivés pour cette page.",
    forkProOnlyHint: "Les forks sont une fonctionnalité Pro. Le propriétaire de la page peut les activer dans les réglages.",
    proBadge: "Pro",
  },
  forkEditor: {
    title: "Fork de {title}",
  ...
  templates: {
    title: "Templates",
    description:
      "Parcourez des templates HTML prêts à l'emploi. Les utilisateurs Pro peuvent les cloner et les personnaliser.",
    ...
    clonesCount: "clonages",
    useTemplate: "Utiliser le template",
    cloning: "Clonage...",
    upgradeToClone: "Upgrade pour cloner",
    signInToClone: "Connectez-vous pour cloner",
    ...
    publishPanel: {
      ...
      publishButton: "Publier en tant que template",
    },
  },
  meta: {
  ...
  pageSettings: {
    ...
    contributionsHint: "Les visiteurs peuvent commenter et suggérer des changements sur cette page.",
    forks: "Autoriser les forks",
    forksHint: "Les visiteurs peuvent forker cette page et partager leur propre version.",
