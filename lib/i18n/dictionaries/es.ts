...
export const es: Dictionary = {
  ...
  contributions: {
    ...
    forkDisabledHint: "Los forks están deshabilitados para esta página.",
    forkProOnlyHint: "Los forks son una funcionalidad Pro. El dueño de la página puede habilitarlos en los ajustes.",
    proBadge: "Pro",
  },
  forkEditor: {
    title: "Fork de {title}",
    subtitle: "Edita el HTML con resaltado de sintaxis y vista previa en vivo antes de crear el fork.",
    close: "Cerrar editor",
    htmlTab: "HTML",
    previewTab: "Vista previa",
    editTitle: "Título del fork",
    authorLabel: "Tu nombre",
    messageLabel: "Mensaje sobre este fork (opcional)",
    iconLabel: "Icono de la página",
    iconEmoji: "Emoji",
    iconText: "Texto",
    iconColor: "Color de fondo",
    cancel: "Cancelar",
    next: "Siguiente",
    back: "Atrás",
    createFork: "Crear fork",
  ...
  templates: {
    title: "Templates",
    description:
      "Explora templates HTML listos para usar. Los usuarios Pro pueden clonar y personalizarlos.",
    ...
    clonesCount: "clonaciones",
    useTemplate: "Usar template",
    cloning: "Clonando...",
    upgradeToClone: "Upgrade para clonar",
    signInToClone: "Inicia sesión para clonar",
    empty: "No se encontraron templates.",
    previous: "Anterior",
    next: "Siguiente",
    ...
    publishPanel: {
      ...
      tagsLabel: "Tags (separadas por coma)",
      tagsPlaceholder: "lead, form, saas",
      publishing: "Publicando...",
      publishButton: "Publicar como template",
    },
  },
  meta: {
  ...
  pageSettings: {
    ...
    contributionsHint: "Los visitantes pueden comentar y sugerir cambios en esta página.",
    forks: "Permitir forks",
    forksHint: "Los visitantes pueden hacer un fork de esta página y compartir su propia versión.",
