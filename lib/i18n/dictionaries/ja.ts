...
export const ja: Dictionary = {
  ...
  forkEditor: {
    title: "{title} のフォーク",
    subtitle: "フォークを作成する前に、シンタックスハイライトとライブプレビューで HTML を編集します。",
    close: "エディタを閉じる",
    htmlTab: "HTML",
    previewTab: "プレビュー",
    editTitle: "フォークタイトル",
    authorLabel: "名前",
    messageLabel: "このフォークについてのメッセージ（任意）",
    iconLabel: "ページアイコン",
    iconEmoji: "絵文字",
    iconText: "テキスト",
    iconColor: "背景色",
  ...
  templates: {
    title: "テンプレート",
    description:
      "すぐに使える HTML テンプレートを閲覧できます。Pro ユーザーはクローンしてカスタマイズできます。",
    ...
    cloning: "クローン中...",
    upgradeToClone: "アップグレードしてクローン",
    signInToClone: "サインインしてクローン",
    empty: "テンプレートが見つかりません。",
    previous: "前へ",
    next: "次へ",
  ...
  pageSettings: {
    ...
    contributionsHint: "訪問者がコメントや提案を行えます。",
    forks: "フォークを許可する",
    forksHint: "訪問者がこのページをフォークして独自のバージョンを共有できます。",
