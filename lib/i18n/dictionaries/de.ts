...
export const de: Dictionary = {
  ...
  templates: {
    title: "Templates",
    description:
      "Durchsuche fertige HTML-Templates. Pro-Nutzer können sie klonen und anpassen.",
    ...
    clonesCount: "Klonungen",
    useTemplate: "Template verwenden",
    cloning: "Klonen...",
    upgradeToClone: "Upgrade zum Klonen",
    signInToClone: "Anmelden zum Klonen",
    ...
    publishPanel: {
      ...
      publishButton: "Als Template veröffentlichen",
    },
  },
  meta: {
    loginTitle: "Anmelden",
